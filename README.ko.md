...
| 26 | **ClickBook 버디 & 포커스 타이머 (Premium)** | 귀여운 디지털 펫 버디와 함께 뽀모도로 타이머로 집중을 유도하고, 등급별 버디 리스트를 볼 수 있는 버디 도감(베이직, 프리미엄, 히든) 기능을 제공하며, 몰입 완료 시 온 스크린을 뒤덮는 웅장한 인터랙티브 완료 효과 테마(오로라 별밤, 고요한 전나무 숲, 타오르는 벽난로, 노을빛 호숫가, 싱잉볼 사운드가 합성된 명상 요가, 그리고 18종의 시네마틱 켄 번즈 만화 카드)를 제공합니다. |
