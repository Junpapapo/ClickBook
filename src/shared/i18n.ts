...
const en = {
  ...
  chromeTextExtractDesc: "Paste text containing URLs. http/https URLs are auto-extracted and saved.",
...
const ja: typeof en = {
  ...
  chromeTextExtractDesc: "URLを含むテキストを貼り付けてください。http/https で始まるURLを自動抽出して登録します。",
...
const ko: typeof en = {
  ...
  chromeTextExtractDesc: "URL이 포함된 텍스트를 붙여넣으세요. http/https URL을 자동으로 추출하여 등록합니다.",
