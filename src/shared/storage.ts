...
export const DEFAULT_SETTINGS: import("./types").AppSettings = {
  ...
  buddyConfig: {
    ...
    opacity: 0.9,
    hiddenSites: [],
    enabledMenuItems: ["translate", "topsites", "bookmark", "memo", "settings"],
    adBlockEnabled: true,
    adBlockBypassDomains: [],
    isTopSitesEnabled: true,
    topSitesExcludeDomains: ["localhost", "127.0.0.1", "192.168.0.1"],
