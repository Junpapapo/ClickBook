export const en = {
  ...
  aiRefining: "Refining...",
  memoSearchPlaceholder: "Search memos and sites...",
  memoDeleteConfirm: "Delete?",
  memoDeleteAction: "Delete",
  memoCancelAction: "Cancel",
  memoSaveAction: "Save",
  memoCopied: "Copied!",
  memoCopyTooltip: "Copy to clipboard",
  memoClearTooltip: "Clear all text",
  memoViewSiteTooltip: "Open linked site",
  memoAllColors: "All",
