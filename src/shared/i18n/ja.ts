export const ja = {
  ...
  aiRefineMemo: "AI整理",
  aiRefining: "整理中...",
  memoSearchPlaceholder: "メモやサイトを検索...",
  memoDeleteConfirm: "削除しますか？",
  memoDeleteAction: "削除",
  memoCancelAction: "キャンセル",
  memoSaveAction: "保存",
  memoCopied: "コピー完了！",
  memoCopyTooltip: "クリップボードにコピー",
  memoClearTooltip: "内容をすべて消去",
  memoViewSiteTooltip: "紐づきサイトを開く",
  memoAllColors: "すべて",
